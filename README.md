...
This component calls an `oninput` callback prop whenever the tags array changes. You can listen for it like this:
...
<Tags
	...
	tagClasses="pr-4"
	removeTagButtonClasses="cursor-pointer rounded px-2 hover:outline"
...
```html
<div class="svelteUnstyledTagsWrapper" id="fyz9g1k7rplq0rl3c8">
	<label for="tagsInput-fyz9g1k7rplq0rl3c8" class="screen-reader-only">Tags</label>
